...
function start() {
  ...
  document.querySelector("[data-filter=cat]").addEventListener("click", clickCatButton);
  document.querySelector("[data-filter=dog]").addEventListener("click", clickDogButton);
